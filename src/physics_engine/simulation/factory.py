...
from ..interaction_laws.classical_boids.interaction import BoidsInteraction
from ..interaction_laws.leader_follower.interaction import LeaderFollowerInteraction
from ..interaction_laws.vicsek_model.interaction import VicsekInteraction
from ..interaction_laws.predator_prey.interaction import PredatorPreyInteraction

from ..interaction_laws.spring_network.config import SpringNetworkConfig
from ..interaction_laws.spring_network.interaction import (
    SpringNetworkInteraction,
)
